...
test('WPKL Awam - Kemaskini Profil Individu', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Katalaluan Baru :', exact: true }).click();
  await page.locator('[id="awam-registration-form:alamatBerdaftar3"]').click();
  await page.locator('[id="awam-registration-form:alamatBerdaftar3"]').fill(timestamp);
