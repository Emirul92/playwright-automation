...
test('WPKL Awam - Kemaskini Profil Syarikat', async ({ page }) => {
  ...
  await page.locator('iframe[title="eTanahAwam"]').contentFrame().getByRole('textbox', { name: 'ID Pengguna' }).fill('je.foo@mahsing.com.my');
  ...
  await page.locator('[id="awam-registration-form:alamatBerdaftar2Organisasi"]').click();
  await page.getByRole('textbox', { name: 'Alamat Berdaftar :' }).click();
