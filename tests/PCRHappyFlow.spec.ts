...
test('WPKL PCR Senario 1 - Happy Flow', async ({ page }) => {

  //-------Constant Declaration---------
  // Maklumat Hakmilik:
  const bandarPekanMukim = 'Mukim Ampang';
  const jnsHakmilik = 'GRN - Geran';
  const noHakmilik = '85713';
  ...
  await page.getByRole('row', { name: '6 PCR - Permohonan Carian' }).getByLabel('Buat Permohonan').click();
